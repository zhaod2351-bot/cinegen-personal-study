...
export const subscribeToProjectSync = (
  listener: (event: ProjectSyncEvent) => void,
): (() => void) => {
...
export const createNewProjectState = (
  ...
  return {
    ...
    title: settings.title || "未命名项目",
    createdAt: Date.now(),
    lastModified: Date.now(),
    stage: "script",
    targetDuration: settings.targetDuration || "60 秒",
